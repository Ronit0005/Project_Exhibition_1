...
# print("Decision Tree CV RMSEs:", tree_rmses*100)
...
# Training 3 models LightGBM , XGBoost , CatBoost
...
print(f"Accuracy of ensemble model {accuracy_score(y_test, final_predictions):.4f}")